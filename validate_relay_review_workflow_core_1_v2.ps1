...
Invoke-Logged $g "transition pending to prechecked" "npm run update:relay-review-status -- --status-path `"$statusPath`" --status prechecked --stage precheck --reason manual_smoke_precheck"
...
Invoke-Logged $g "transition prechecked to accepted" "npm run update:relay-review-status -- --status-path `"$statusPath`" --status accepted --stage accept --reason manual_smoke_accept"
...
Invoke-Logged $g "invalid transition accepted to pending" "npm run update:relay-review-status -- --status-path `"$statusPath`" --status pending --reason invalid_transition_smoke_test" $true
