...
const packageContractVersion = candidate?.reviewPackageContractVersion ?? lock.reviewPackageContractVersion;
const authContractVersion = candidate?.reviewAuthPortVersion ?? lock.reviewAuthPortVersion;
const packageContractMatches = packageContractVersion === compatibility.reviewSubmission.packageContractVersion;
const authContractMatches = authContractVersion === compatibility.reviewAuth.contractVersion;
