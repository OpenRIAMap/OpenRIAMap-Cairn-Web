...
const required = [
  'src/components/Review/contracts.ts', 'src/components/Review/session.ts', 'src/components/Review/adapterRegistry.ts', 'src/components/Review/index.ts', 'src/components/Review/submission.ts',
