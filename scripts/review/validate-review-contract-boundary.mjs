...
const required = [
  ...
  'project-config/templates/review/reviewWorkspace.extension.template.json', '.cairn/case-template-manifest.json',
];
...
const allowed = new Set([...required, 'docs/ReviewWorkspaceContracts.md', 'scripts/review/validate-review-contract-boundary.mjs', 'scripts/review/validate-case-template-manifest.mjs', 'scripts/review/test-review-workspace-contracts.ts', 'Update_Log/CM_REVIEW_WORKFLOW_CONTRACTS_1.md', 'package.json']);
