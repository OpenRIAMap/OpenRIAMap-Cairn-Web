...
/**
 * The authenticated public release-history projection intentionally has its
 * own API surface. The browser keeps only its normal session cookie; it never
 * receives COS, GitHub or SCF credentials.
 */
