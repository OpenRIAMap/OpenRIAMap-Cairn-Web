  ...
  if (step === 'plfDown') {
    ...
    return (
      <div className="p-3">
        ...
        <div className="space-y-3">
          <LabeledInput label="车站内站台编号" value={plfNoDown} onChange={setPlfNoDown} placeholder="例如：1" />
    ...
    return (
      <div className="p-3">
        ...
        <div className="space-y-3">
          ...
          <LabeledInput label="车站内站台编号" value={plfNoUp} onChange={setPlfNoUp} placeholder="例如：1" />
