...
export function buildGenericFeatureInfoFromSchema(
  ...
  // Never dual-write the legacy source field. A normal editor write becomes a
  // canonical one-component geometry; the multipart editor can replace it with
  // multiple components before saving.
